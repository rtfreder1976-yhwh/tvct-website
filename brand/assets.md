...
| ----- | ---- | ---- | -------- | ------ | ----- |
| Commercial quote follow-up (4 emails) | Email sequence | 2026-08-25 | commercial-quote-follow-up | draft | Angle 5 (2-hour written quote); Day 0/4/10/21 for the slower B2B cycle; measured register, no wit, non-clinical only, no numeric commercial price; pairs with the Hiring Sheet in email 3. For medical batch #4. campaigns/commercial-quote-follow-up/ |
