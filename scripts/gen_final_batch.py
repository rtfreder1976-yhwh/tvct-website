...
- 9 IG carousel slides (light / charcoal / photo-led per locked direction)
...
LIGHT_BASE = (
    "Editorial typographic poster, 1080x1080 square format. Soft light grey background "
    "(#E5E5EA), clean and smooth. Warm high-contrast serif typography (Playfair Display "
    "style) in charcoal (#333333). Peach accent (#FFA985) reserved for one "
    "element only — an arrow, a single brushstroke underline, or a number. Generous negative "
    "space, 10 percent margin on all sides. Single focal point. Warm, friendly, approachable, "
    "trustworthy. Avoid: navy, cream, brass, gold, luxury editorial styling, exclamation "
    "points, sparkles, neon colors, gradients, drop shadows, photographic elements, cartoon, "
    "all-caps stacking."
)

CHARCOAL_BASE = (
    "Editorial typographic poster, 1080x1080 square format. Deep charcoal background "
    "(#333333) with subtle matte texture. Warm high-contrast serif typography (Playfair "
    "Display style) in soft off-white. Peach accent (#FFA985) reserved for ONE element only "
    "— the large numeral or a single underline. Generous negative space. Single focal point. "
    "Warm and confident rather than cold or corporate. "
...
PHOTO_BASE = (
    "Warm, real, lived-in residential lifestyle photograph — a home someone actually lives "
    "in, not a showroom. Soft natural daylight from a window, warm 5000K color temperature, "
    "slight film grain. Real residential kitchen with white-oak cabinetry, white-oak island, "
    "soft white walls. Composition has generous negative space for typography overlay. "
    "Avoid: stock-photo cleaners, feather dusters, sparkles, neon, harsh studio flash, "
    "multiple people, comic effects, cream or brass color grading, luxury-magazine styling."
)
...
SLIDES = [
    ...
    (
        ...
        LIGHT_BASE + " The composition reads on three lines, centered, with the headline "
        "taking the upper two-thirds: large charcoal serif headline reading \"Most cleaning "
        "quotes take 5 days.\" Below it, slightly smaller matching serif, also charcoal: "
        "\"Here is how to get one in 2 hours.\" In the bottom-right corner, a small "
        "peach right-pointing arrow followed by the lowercase humanist sans-serif "
        "word \"swipe\". No other elements."
    ),
    (
        "slide-02-setup.png", "1:1",
        LIGHT_BASE + " The text is left-aligned with a single peach short horizontal "
        "rule above the headline. Charcoal serif headline reads: \"The way most cleaning gets "
        "sold is broken.\" Below it, three lines of body copy in a smaller humanist "
        "sans-serif, charcoal: \"Day 1 — you fill out a form.\" \"Day 3 — someone walks your "
    ...
    (
        ...
        CHARCOAL_BASE + " The composition leads with a giant peach numeral \"1\" in the "
        "upper-left, set in editorial serif at very large scale. To its right, an off-white "
        "serif headline reads on two lines: \"Decide what kind of clean you actually "
        "need.\" Below the headline, three lines of smaller off-white humanist sans-serif "
    ...
    (
        ...
        CHARCOAL_BASE + " The composition leads with a giant peach numeral \"4\" in the "
        "upper-left, set in editorial serif at very large scale. To its right, an off-white "
        "serif headline: \"Time the response.\" Below the headline, four lines of off-white "
    ...
    (
        ...
        CHARCOAL_BASE + " The composition leads with a giant peach numeral \"6\" in the "
        "upper-left, set in editorial serif at very large scale. To its right, an off-white "
        "serif headline on two lines: \"Get the arrival window in writing.\" Below the "
        "headline, three lines of off-white humanist sans-serif body copy: \"A real booking "
        "comes with a 2 to 4 hour window, sent by text.\" \"\\\"We will try to fit "
        "you in\\\" is not a scheduled appointment.\""
    ),
    (
        "slide-06-item-7.png", "1:1",
        CHARCOAL_BASE + " The composition leads with a giant peach numeral \"7\" in the "
        "upper-left, set in editorial serif at very large scale. To its right, an off-white "
        "serif headline on two lines: \"Ask for a flat price. Not starting at.\" Below "
        "the headline, three lines of off-white humanist sans-serif body copy: "
    ...
    (
        ...
        CHARCOAL_BASE + " A off-white serif headline at top, left-aligned: \"3 bonus questions "
        "that reveal a serious cleaner.\" Below it, three numbered questions, each on its "
        "own line, in off-white serif. Each question is preceded by a peach short "
    ...
    (
        ...
        LIGHT_BASE + " A charcoal serif headline at top, left-aligned: \"The full checklist.\""
        " Below the headline, seven numbered items in a single column, each on its own "
        "line, set in humanist sans-serif charcoal text. Each number is preceded by a small "
        "peach checkmark glyph. Items: \"1. Decide the category.\" \"2. Bedrooms + "
    ...
    (
        ...
        PHOTO_BASE + " A clipboard holding a printed white-paper checklist with a charcoal "
        ...
        "the upper two-thirds. Across the upper third, in bold charcoal serif typography "
        "overlaid on the kitchen scene: \"Want the full PDF?\" Below it, in smaller "
        "humanist sans-serif charcoal: \"Free. 5 minutes to read. Link in bio or DM "
        "\\\"checklist\\\".\" A small charcoal word-mark reading \"The Valley Clean "
    ...
    (
        ...
        PHOTO_BASE + " Aspect ratio 4:5, 1080x1350. A single sheet of white paper rests "
        "centered on the white-oak kitchen island in soft morning light. Printed on the "
        "paper in bold charcoal editorial serif typography, perfectly readable: \"The 2-Hour "
        "Quote Checklist\". Below the title, in smaller charcoal humanist sans-serif: "
        "\"7 things to know before you book any cleaner.\" Below that, a small "
        "peach horizontal rule. Below the rule, in small charcoal serif italic: "
    ...
    (
        ...
        "its cover page; the cover reads in bold charcoal editorial serif: \"The 2-Hour Quote "
        ...
        "negative space, in small bold charcoal serif: \"The 2-Hour Quote Checklist · Free "
