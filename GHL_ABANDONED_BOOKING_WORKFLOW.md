...
4. **Send SMS** (the highest-recovery step):
   ...
   info's already filled in): https://thevalleycleanteam.com/booking?f_name={{contact.first_name}}&l_name={{contact.last_name}}&email={{contact.email}}&phone={{contact.phone}}
   ```
5. **Wait** — 1 hour.
